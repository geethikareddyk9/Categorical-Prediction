...
train_label = tk.Label(root, text="Training data file: None")
train_label.pack(pady=10)
button_train = tk.Button(root, text="Open Training File", command=open_train_file)
button_train.pack(pady=10)

label = tk.Label(root, text="Test data file: None")
label.pack(pady=10)
button_test = tk.Button(root, text="Open Test File", command=open_test_file)
